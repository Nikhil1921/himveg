                            ...
                            <div class="row">
                                <div class="col-md-6 location">
                                    ...
                                    <input type="text" name="address" class="form-control" id="address"
                                           placeholder="{{\App\CPU\translate('Delivery area address')}}" value="{{old('address')}}" >
                                ...
                                <div class="col-md-6">
                                    <label for="vehicle_name">{{\App\CPU\translate('Licence No.')}}</label>
                                        <input type="text" name="vehicle_name" class="form-control" id="vehicle_name"
                                            placeholder="{{\App\CPU\translate('Licence No.')}}" value="{{old('vehicle_name')}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label for="rc_no">{{\App\CPU\translate('Home address')}}</label>
                                        <input type="text" name="rc_no" class="form-control" id="rc_no"
                                            placeholder="{{\App\CPU\translate('Home address')}}" value="{{old('rc_no')}}" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="insurance_no">{{\App\CPU\translate('Aadhar No.')}}</label>
                                        <input type="text" name="insurance_no" class="form-control" id="insurance_no"
                                            placeholder="{{\App\CPU\translate('Aadhar No.')}}" value="{{old('insurance_no')}}" required>
                                </div>
                            </div>
                        </div>
