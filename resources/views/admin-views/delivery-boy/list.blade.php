...
@section('title', \App\CPU\translate('Delivery Boy List'))
@push('css_or_js')
...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('Delivery Boy')}}</li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{\App\CPU\translate('delivery_boy_table')}}</h5>
                    <a href="{{route('admin.delivery-boy.add-new')}}" class="btn btn-primary  float-right">
